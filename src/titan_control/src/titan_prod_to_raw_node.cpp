...
int main(int argc, char **argv)
{
	...
	move_base_msgs::MoveBaseGoal goal;
        ...
        goal.target_pose.pose.position.x = 8.734;
        goal.target_pose.pose.position.y =  -36.334;
        goal.target_pose.pose.orientation.z = -0.152;
	...
	goal.target_pose.pose.position.x = -1.777;
        goal.target_pose.pose.position.y =  -17.44;
        goal.target_pose.pose.orientation.z = 0.452;
        goal.target_pose.pose.orientation.w = 0.892;
	...
	ROS_INFO("Goal 2 reached");
 	...
 	goal.target_pose.pose.position.x = 5.282;
        goal.target_pose.pose.position.y =  -3.468;
        goal.target_pose.pose.orientation.z = 0.657;
	...
	goal.target_pose.pose.position.x = -1.338;
        goal.target_pose.pose.position.y =  -1.746;
        goal.target_pose.pose.orientation.z = 0.950;
        goal.target_pose.pose.orientation.w = -0.312;
