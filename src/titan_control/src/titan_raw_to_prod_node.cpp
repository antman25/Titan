...
int main(int argc, char **argv)
{
	...
	move_base_msgs::MoveBaseGoal goal;
        ...
        goal.target_pose.pose.position.x = 3.248;
        goal.target_pose.pose.position.y =  0.677;
        goal.target_pose.pose.orientation.z = 0.159;
        goal.target_pose.pose.orientation.w = 0.987;
	...
	goal.target_pose.pose.position.x = -1.921;
        goal.target_pose.pose.position.y =  -17.786;
        goal.target_pose.pose.orientation.z = -0.369;
	...
	ROS_INFO("Goal 2 reached");
 	...
 	goal.target_pose.pose.position.x = 8.687;
        goal.target_pose.pose.position.y =  -28.316;
        goal.target_pose.pose.orientation.z = -0.472;
        goal.target_pose.pose.orientation.w = 0.882;
	...
	goal.target_pose.pose.position.x = 3.830;
        goal.target_pose.pose.position.y =  -33.796;
